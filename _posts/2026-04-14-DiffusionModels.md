...
\begin{align}  \\
 ...
 &=\mathbb{E}_{q(x_{1:T}|x_{0})}[\: \log(\: \frac{p_{\theta}(x_{0:T}) \cdot q(x_{1:T}|x_{0})}{q(x_{1:T}|x_{0}) \cdot p_{\theta}(x_{1:T}|x_{0})} )\:] 
\end{align} \qquad (3b) 
...
\begin{align}  \\
 ...
 &=\underbrace{\mathbb{E}_{q(x_{1:T}|x_{0})}[\: \log(\: \frac{p_{\theta}(x_{0:T}) }{q(x_{1:T}|x_{0})})\:]}_{ELBO} + D_{KL}(q(x_{1:T}|x_{0})\: || \: p_{\theta}(x_{1:T}|x_{0}))
\end{align} \qquad (3c)
$$
...
\mathbb{E}_{q(x_{1:T}|x_{0})}[\: -\log(\:p_{\theta}(x_{0:T})\:)\:]   &\leq \underbrace{\mathbb{E}_{q(x_{1:T}|x_{0})}[\: -\log(\: \frac{p_{\theta}(x_{0:T}) }{q(x_{1:T}|x_{0})})\:]}_{ELBO} \\ \\
\end{align} \qquad (3e)
$$
...
&= \mathbb{E}_{q(x_{1:T}|x_{0})}\left[ -\log(  p_{\theta}(x_{T}) - \sum_{t\geq 1} \log(\frac{p_{\theta}(x_{0:T}) }{q(x_{1:T}|x_{0})}) \right]
\end{align} \qquad (3f)$$
